...
NDefines.NTechnology.BASE_YEAR_AHEAD_PENALTY_FACTOR = 6; -- default 2
...
NDefines.NNavy.RESOURCE_LENDLEASE_PRIORITY = 10;		--default 3						-- Default convoy priority for export lend lease
